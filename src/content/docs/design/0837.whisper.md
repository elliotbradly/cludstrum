---
title: 0837.whispertitle
description: A reference page in my new Starlight docs site.
---

you really should be doing something else 
beside watching paint dry 
writing out your words is a fine place to start 
you do feel alive this morning 
things are rocking and rolling 
as the paint dries 
that would be a great name for a soap opera 
so you just feel like writing what ever comes to your mind this morning 
as you compplate not going to church 

you place an order for an alligator product 
choose you farm
the deliver agents go out and get the item 
however there are alligator men lurking in the swamp
allong with the alligators 
and there all vampire bunnies as well
as they slog through the mud 

its about having a character in less than hour 
while you are creating insurance paper work 

then the artwork moves around like pawns 
on a board game watched by millions 
...
/ would return with just the timecode 
/update could change the timecode 

fang swamp 
home to 11,000 differrent species of reptiles

watch fang swamp run 

i guess we could always just collect words 

steps to create a distrubuted system
one 
update request file 
browserify 
wrangler local 
...
what do you see
i see a movie in the mind 
you could create the sequeincail art piece you have been considering 


what are we doing 
build the simulation
disrubuted amoung many computers 
we are starting with the time 
the time pivot needs to be stateless 


space person rolling an odd wad into a shoot

oddwad plummeting

screaming of metal falling through space

oddwadd crashing in to the swamp

oddwadd releasing clutching into the mud 

oddwad protecting clutching
...
ok let us zoom a head for a moment
you indeed get all of those locations in the game
now you need beeings

greasi wanted to make things clean for beeittle 

coffee blast running through the veins with dreams of bean babie fortunes 
what we we attempting to do 
i can see on the screen a board of hexes 
with items in each hex 

red:  severe arm
purple : experience an ephinay that will bring about world peace 
pink : perceive a vision that has never been seen before 
blue : have a dream about a duck
green : shooting with a pistol a target at point blank range
purple : stopping bullets in mid-air with your breath  
pink : stopping bullets in mid-air with a weapon  
red : jumping from a rooftop into a small window across the alley  
orange : steering your car into oncoming traffic and avoiding collisions while at high speeds  
yellow : driving through an intersection full of speeding cross traffic  
brown : avoiding jaywalkers who suddenly step in front of your car during a high speed chase 
green : Driving a car in moderate traffic during a rainstorm
blue : driving a car in moderate traffic
blue : put your sock on 
green : type your thoughts on to a computer

hmmm
where to next 
create a list of everday activities
simulate in words the placing of clothes on a body 

things to bestow
all american alligator delivery service 
a listing of various alligators
the rules to defeat them in chain form 
...
simon beeing 
astrokahn
promethus postmodern 
an umbrella of characters 


how does one best construct a simlation

You can only speculate that you need to simulate all possible combinations 
of colors, then all possible combinations of shapes (and so forth), 
and finally all possible combinations of sounds. 

You will need to define some kind of reality 
what do people actually see, hear or feel when they experience such things
The next question is how are we going to simulate it accurately 
When means you could introduce errors and you would want to introduce these as little as possible

two course of action 
make up a bunch of stuff
take actual events and try to recreate them

the limitations of your mind would prevent you from making it realistic enough for anything more than amusement purposes

As far as you're concerned, it's time to leave this world now!
This was the sentiment of Simo Beeing so he felt that he needed to build this next reality 

Of course how 

How much information do we want to include? 
How realistic is our model? 
Is it sufficient for simulating the entire brain or would additional features be useful? 
What other types of cells and structures could we simulate?
Or would we move into something more abstract 

You can't imagine any way you could do it, 
but then again there's no reason why you couldn't come up with something clever. 
But if you don't know how to simulate reality, what purpose would such a thing serve anyway? 
Would it be useful as a tool for predicting future events or even just entertaining yourself? 

You can only guess, but you think it will be easier if you use the most common methods. 
The first is to use as many existing programs as possible. 
This way, you'll have all the data you need to create the simulation. 
Of course there are some limitations:
it could be as simple as simulating a person's brain, 
in that case they must have a large number of neurons since neurons represent thought processes

Then you would need to populate the simulate with a large number of people, 
each with their own unique skills and abilities. 
Each person needs to know everything they can about the subject matter 
(such as when it was seen, how long ago, etc.) 
The more people involved the better because then you will have more data points for your simulations.

a. The first thing you should do is look at your own personality traits to see what sort of person you are. 
You can find out by taking the Personality Inventory . 
This will give you a good idea as to how much variance there is within your personality. 
It's not enough just to know if you're a "sociopath" or "psychotic."

to simulate their dreams?
How to tell the truth when they are talking about something so abstract?
What do you think would happen if you gave this person money for doing nothing but fantasizing about computers all day long?
What is the difference between a programmer and a hacker?
Why did the universe create two people with identical DNA, yet only one of them could program a computer ?

The answer is not to simply make up random numbers, 
but rather to take the most likely combination of these possible combinations. 
In other words, you need to choose a "seed" number which will be used as the basis for all subsequent simulations. 
You can't just randomly generate any seed number because it would result in very different results! 
The problem with using random numbers is that they are unpredictable; 
if there were no chance involved then we wouldn't even have to think about them.

You can only attempt to recreate it, not create it.

There are many variables to consider,
but there is one constant: what would you do if given this situation? How would you react?
You must choose between two possible actions. 
One is to use the information you have gathered so far to make decisions based on which action will result in the most fun for yourself.
The other option is to ignore all the information and simply play out whatever scenario comes into your head as it happens. 

a) make it so realistic that you can't tell the difference between reality and simulation.
b) make it so complex that you will be unable to simulate even one neuron within the simulated brain.

1. The computer simulates all possible futures, 
and then chooses which one it will use as its own. 

The first thing you must do is determine how many people will be in the game. 
This can easily be done by asking yourself, 
"How much time would it take me to play this game for four hours?" 
If it takes you less than 4 hours, then you don't need more than three players. 
If it takes longer than that, then four is probably too few. 

then you can use this simulated reality to predict future events and even manipulate them. 
This process requires the most computing power and energy available. 
The more accurate the simulation, the better it will perform.

How do you know what these simulations are predicting? By using math!

Reality is just another word for what you see when you look out your window every day. 
 But there are other words for what we do not experience directly: 
 such as our subjective perceptions of time, space and causality. 


The computer simulation is just the first stage. 
The second stage is to create a believable world where you can live your life, 
and eventually even build a civilization out of it. 
You need to start by creating realistic objects such as trees, rocks, buildings, cars etc. 
Then you need to make them move around like real things do (or rather they should be able to).
we just think that if you could map out its inner workings, 
 
The computer simulation must be made up of millions of individual components, 
each with their own characteristics. 
The more complex the system is, the more difficult it will be for you to predict what will happen next! 
This means that even if you were able to do so, you would not know exactly how well your simulations are doing. 
You need to make sure that your simulation can handle all possible combinations of events and situations!

How do you feel about the possibility of being killed by a bullet or falling off a building?
What is your opinion on whether it would be better if I had sex with this girl, 
or had her send me some pictures instead?

The answer is simple. 
All you need to do is create a simulation of the universe, 
then simulate it for as long as possible until all the laws of physics are broken down completely 
and the laws of mathematics are applied. 
The simulation will eventually become so complex that nothing can be simulated anymore and 
the universe itself will collapse in on itself like a black hole. 
You will see everything that could ever happen occur.

The first thing you need to do is decide what you are going to be simulating. 
You could simulate the entire history of the universe, 
or just the last few billion years of human civilization. 
It doesn't matter because what matters is that it will allow you to create a simulated version of yourself.
You then choose which aspects of reality you want to include and how much detail you want them to have.

In this simulation, you are asked to select the most important qualities that make up what makes for a good person. 
You can then choose from among those qualities to create your own idealized version of yourself. 
The more choices you give, the more realistic your self-image will be. 
You may also choose which characteristics of other people you would like to emulate in order to get closer 
or further away from your current position in life.

The answer is not as simple as it might seem. 
The first thing to be determined is what we are trying to simulate. 
Is this the entire human mind, 
or just certain aspects of it? 
If so, then the only way to do this accurately would be by creating an exact replica of every neuron in the brain 

All you do know is that it will be fun to play with, 
and if you're lucky, it might even help you save the human race from extinction!

The game begins with you standing on top of a hill overlooking 
a city called New York City. 
The buildings are tall and slender, like those of an old English townhouse.

of reality? 
How do you make it so realistic 
that even the most uneducated person can understand what is going on ?
The answer to these questions lies within the computer program called Reality. 

There are several ways to approach this problem. 
I think the most important is to try to create a computer model that approximates reality as closely as possible, 
then you can test it by using different parameters and see which ones cause the simulation to behave in an unrealistic manner.
You could also do something similar for each parameter individually 
and see what happens when those parameters are changed until you find the one that causes the simulation to behave realistically.

 of the human brain?
The answer is to start by creating a virtual brain. 
This can be done either using a 3D model or even just by scanning the real thing. 
The scan technique is usually faster, 
but it's also more expensive and time consuming (the scan takes anywhere between 1 minute to 2 hours).


In order for this game to be successful, 
it must have some sort of goal. 

If the player doesn't know what the goal is, 
then they will not care if there are any glitches or bugs in the program. 

The purpose of this game should be to teach you how to use the computer as well as how to think logically and solve problems.

You are standing in a room filled with computers. 

There is a monitor, which shows you two screens. 

One screen displays numbers, while the other display words. 

The words appear randomly as you turn your head left and right.

What do you see on the first screen?
The number "1" appears on the first screen every time it would normally be there, 

but instead it appears when no number should be there.

You can make it so that every character's emotions are represented by their physical characteristics 
(e.g., "A woman who is 6' tall and weighs 160 pounds") 
or they can be represented by their thoughts ("A man who thinks he's a princess").

"How do you know all this?" You ask. "I just saw it for myself."

"You really think they would let us into their secret place if we didn't have some proof to back up our claims?"

"They might be too busy fighting each other right now, 
but I'm sure when the time is right, they will allow us entry!" 

The Operator says. "But how can I help you today?"

a) A computer simulator is not as simple as it seems. 
There are many variables that must be taken into account, some of which can't even be imagined. For example:

b) You can only simulate things within the realm of reality, not outside it. 

If you try to do something impossible like create a simulated universe or travel to another dimension 
then you will fail and end up destroying yourself in the process.

The first thing you need is some sort of physical representation of the world. 

You could try to create it out of numbers, 
but numbers are just too slow for such things as your simulation. 

Instead, you can use real objects that will help represent the world: buildings, cars, people, etc... 

In fact if you were going to go down this route then perhaps the most important object would be time itself! 

Time represents our perception of reality.

 to simulate the way you see reality? 
 
 How do you know when it is not accurate enough? 
 
 What are some ways to improve your ability to accurately describe what you experience ?

 How do you determine what is real and what is not, 
 when all possibilities are possible? This question leads us to the next.
What would happen if we were able to simulate every possibility for our world? 
What would be the consequences of such a feat? 
Would it even work or would it cause us problems like time paradoxes or other oddities?
In order to answer these questions, we will first need some basic knowledge about probability theory.

 to experience these visions? How do you know if the visions are real or not? The answers may be found within this book.

This is not just a story, but also a guidebook for living life. 
This book will help you find out what it means to live in harmony with nature and yourself. 
It will show how we can become more aware of our surroundings so as to avoid unnecessary conflict.

you can't. you're not smart enough, or lucky enough, or talented enough. 
you don't even know how it's done.
what are some things that could be simulated so as to give you a better understanding of your own mind?
the answer lies in the fact that every human being is a complex machine made up of many parts 
(as opposed to just the brain) which when combined work together like a well designed system.

You could try to recreate your experience, but I'm not sure if it would be accurate. 
If anything, it might make things worse by adding more details or making them seem more realistic. 
You could also use the technology available today to create something similar, 
but in a computer program. A simple game like "SimCity" is all you need.

You will have to ask yourself this question, because you can't do it. 
You are not smart enough or talented enough to come up with any good answers for such questions. 
So instead you simply try to imagine all possible outcomes and then choose the most likely one based on your current state of mind.

f this? The answer is simple. You do not need to simulate every possible combination of events, 
just those that you believe are most likely to occur. 
This gives you a list of possibilities that you can then test for each one individually. 
If there are any events which cannot be simulated (for example if they involve quantum physics), 
they will not appear on the list and you won't get any points for them.

Well, I could try to make it so that you can only choose between the various colors. 
This would probably be the most difficult part since there are many more possibilities than just those four. 
Then again, if I made it so that you couldn't do anything but select one color then this might not even be necessary.




we need to create a list of these results for the simulation

A: you do not know how to create such a simulation, so you are forced to ask for help. 
The only person that can help is the man who was sitting next to you when you had your dream. 
He says he knows how to create such simulations; however, 
it will cost him ten thousand dollars. 

You cannot afford this price tag! You would rather die than pay this amount of money!

how does one best construct a computer simulation
 of what you see?
what are some things to do when confronted by a sudden crisis?
What is the most productive way to spend time with friends or family?
How can I get out of this situation as quickly as possible without causing trouble for myself, my loved ones, or society in general?

of yourself to give you these visions? How do you know when they are "seeing" something, 
or if it is just a hallucination?
A. You can't tell the difference between them and you don't want to be wasting time trying to figure out what they mean.
 B. The visions seem real enough for you to try and determine their meaning, but it isn't possible due to lack of information. C.

 The answer is simple: you do not. You cannot, 
 because there are no computers that can simulate what you see or experience.
  The only thing that could be simulated would be the world as it really exists (which is very different than how you experience it) 
  but even then, there are limits to how accurate such simulations can ever be.
...
those are all words that do not exist

i am im·ag·i·na·tive and i love you!
plus i can not stop loving you ,

so what is next 
well it looks like we are writing again as i begin the morning spitting blood 
took a break from this as the stomach churns 
some patterns repeat themselves

so what are we attepting to do before we die 

create some novelty

chambers : English author (1860-1936) whose novels often deal with the problems of modern society, 
particularly the effects of technology on human relationships; 
she is best known for her novel The Golden Bowl (1930), 
about a woman who marries into a family that owns a large company making machines to make people sterile so they can live forever 
...
the resolution reactor  
we had two ideas

one involved dice 
and the other involved color 

you have ten side dice
the higher the skill level the more dice 
every action held a difficulty value 
if you roll the dice over this value you have the power to accomplish your ends
if you roll under then you have failed 
if you roll a certain percentage over you would succeed fantasically and special things happen
there would be a way to dramaticly fail 

colored dice 

so there is a color that lets you roll another color
11 colors 
...
//bold
//unimaginable : black, only those who are One with God may attempt these tests. 

supernatural : 00, purple, only those in connection with forces outside of reality can attempt these tests
Example: Stopping bullets in mid-air with your breath 

epic: 01, pink, A character must have the most advanced skill in the perfect beeing in order to even think of attempting such an action
Example: Stopping bullets in mid-air with a weapon 

bold: 02, red, only the luckiest and most skilled are successful
Jumping from a rooftop into a small window across the alley

daring: 03, orange, even pros have a hard time pulling these attempts off
Example: Steering your car into oncoming traffic and avoiding collisions while at high speeds.

tough: 04, yellow, only highly skilled characters succeed at these with any regularity
Example: Driving through an intersection full of speeding cross traffic. 

demanding : 05, brown, requires a fair amount of skill and/or effort. Most unskilled characters will fail such an attempt
Example: Avoiding jaywalkers who suddenly step in front of your car during a high speed chase.

comfortable : 06, green, most characters should be able to do this most of the time, though there is still a chance for failure. 
Example: Driving a car in moderate traffic during a rainstorm

gentle : 07, blue, anyone should be able to do this most of the tim
Example: Driving a car in moderate traffic

providence : 08, white

destiny : 09, black

crisis : 10, achromatic one

oppression : 11, achromatic zero

it should work like a wave 

instead of just randomly jumping from point to point with regularity 
this only occurs sporatracticly 
in failure and success breathes 

sigh and spin 

so you have a chain of resolutions that rise and fall



Chapter 000-home-office
