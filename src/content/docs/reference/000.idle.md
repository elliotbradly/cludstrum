...
Of course. Here is a comprehensive overview of the idle/incremental/clicker genre from a narrative context, using the seminal text-based game *A Dark Room* as its primary case study.
